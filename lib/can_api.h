...
#define CAN_ID_WHEEL_SPEED_F_L ((uint16_t) 0x16)
#define CAN_ID_WHEEL_SPEED_F_R ((uint16_t) 0x17)
#define CAN_ID_WHEEL_SPEED_B_L ((uint16_t) 0x18)
#define CAN_ID_WHEEL_SPEED_B_R ((uint16_t) 0x19)
#define CAN_ID_SUS_TRAVEL_F_L ((uint16_t) 0x1A)
#define CAN_ID_SUS_TRAVEL_F_R ((uint16_t) 0x1B)
#define CAN_ID_SUS_TRAVEL_B_L ((uint16_t) 0x1C)
#define CAN_ID_SUS_TRAVEL_B_R ((uint16_t) 0x1D)
#define CAN_ID_SUS_STRAIN_F_L_1 ((uint16_t) 0x1E)
#define CAN_ID_SUS_STRAIN_F_L_2 ((uint16_t) 0x1F)
#define CAN_ID_SUS_STRAIN_F_L_3 ((uint16_t) 0x20)
#define CAN_ID_SUS_STRAIN_F_R_1 ((uint16_t) 0x21)
#define CAN_ID_SUS_STRAIN_F_R_2 ((uint16_t) 0x22)
#define CAN_ID_SUS_STRAIN_F_R_3 ((uint16_t) 0x23)
#define CAN_ID_SUS_STRAIN_B_L_1 ((uint16_t) 0x24)
#define CAN_ID_SUS_STRAIN_B_L_2 ((uint16_t) 0x25)
#define CAN_ID_SUS_STRAIN_B_L_3 ((uint16_t) 0x26)
#define CAN_ID_SUS_STRAIN_B_R_1 ((uint16_t) 0x27)
#define CAN_ID_SUS_STRAIN_B_R_2 ((uint16_t) 0x28)
#define CAN_ID_SUS_STRAIN_B_R_3 ((uint16_t) 0x29)
#define CAN_ID_TIRE_TEMP_F_L_1 ((uint16_t) 0x2A)
#define CAN_ID_TIRE_TEMP_F_L_2 ((uint16_t) 0x2B)
#define CAN_ID_TIRE_TEMP_F_L_3 ((uint16_t) 0x2C)
#define CAN_ID_TIRE_TEMP_F_L_4 ((uint16_t) 0x2D)
#define CAN_ID_TIRE_TEMP_F_R_1 ((uint16_t) 0x2E)
#define CAN_ID_TIRE_TEMP_F_R_2 ((uint16_t) 0x2F)
#define CAN_ID_TIRE_TEMP_F_R_3 ((uint16_t) 0x30)
#define CAN_ID_TIRE_TEMP_F_R_4 ((uint16_t) 0x31)
#define CAN_ID_TIRE_TEMP_B_L_1 ((uint16_t) 0x32)
#define CAN_ID_TIRE_TEMP_B_L_2 ((uint16_t) 0x33)
#define CAN_ID_TIRE_TEMP_B_L_3 ((uint16_t) 0x34)
#define CAN_ID_TIRE_TEMP_B_L_4 ((uint16_t) 0x35)
#define CAN_ID_TIRE_TEMP_B_R_1 ((uint16_t) 0x36)
#define CAN_ID_TIRE_TEMP_B_R_2 ((uint16_t) 0x37)
#define CAN_ID_TIRE_TEMP_B_R_3 ((uint16_t) 0x38)
#define CAN_ID_TIRE_TEMP_B_R_4 ((uint16_t) 0x39)
...
#define CAN_LEN_WHEEL_SPEED_F_L ((uint16_t) 2)
#define CAN_LEN_WHEEL_SPEED_F_R ((uint16_t) 2)
#define CAN_LEN_WHEEL_SPEED_B_L ((uint16_t) 2)
#define CAN_LEN_WHEEL_SPEED_B_R ((uint16_t) 2)
#define CAN_LEN_SUS_TRAVEL_F_L ((uint16_t) 3)
#define CAN_LEN_SUS_TRAVEL_F_R ((uint16_t) 3)
#define CAN_LEN_SUS_TRAVEL_B_L ((uint16_t) 3)
#define CAN_LEN_SUS_TRAVEL_B_R ((uint16_t) 3)
#define CAN_LEN_SUS_STRAIN_F_L_1 ((uint16_t) 8)
#define CAN_LEN_SUS_STRAIN_F_L_2 ((uint16_t) 8)
#define CAN_LEN_SUS_STRAIN_F_L_3 ((uint16_t) 8)
#define CAN_LEN_SUS_STRAIN_F_R_1 ((uint16_t) 8)
#define CAN_LEN_SUS_STRAIN_F_R_2 ((uint16_t) 8)
#define CAN_LEN_SUS_STRAIN_F_R_3 ((uint16_t) 8)
#define CAN_LEN_SUS_STRAIN_B_L_1 ((uint16_t) 8)
#define CAN_LEN_SUS_STRAIN_B_L_2 ((uint16_t) 8)
#define CAN_LEN_SUS_STRAIN_B_L_3 ((uint16_t) 8)
#define CAN_LEN_SUS_STRAIN_B_R_1 ((uint16_t) 8)
#define CAN_LEN_SUS_STRAIN_B_R_2 ((uint16_t) 8)
#define CAN_LEN_SUS_STRAIN_B_R_3 ((uint16_t) 8)
#define CAN_LEN_TIRE_TEMP_F_L_1 ((uint16_t) 8)
#define CAN_LEN_TIRE_TEMP_F_L_2 ((uint16_t) 8)
#define CAN_LEN_TIRE_TEMP_F_L_3 ((uint16_t) 8)
#define CAN_LEN_TIRE_TEMP_F_L_4 ((uint16_t) 8)
#define CAN_LEN_TIRE_TEMP_F_R_1 ((uint16_t) 8)
#define CAN_LEN_TIRE_TEMP_F_R_2 ((uint16_t) 8)
#define CAN_LEN_TIRE_TEMP_F_R_3 ((uint16_t) 8)
#define CAN_LEN_TIRE_TEMP_F_R_4 ((uint16_t) 8)
#define CAN_LEN_TIRE_TEMP_B_L_1 ((uint16_t) 8)
#define CAN_LEN_TIRE_TEMP_B_L_2 ((uint16_t) 8)
#define CAN_LEN_TIRE_TEMP_B_L_3 ((uint16_t) 8)
#define CAN_LEN_TIRE_TEMP_B_L_4 ((uint16_t) 8)
#define CAN_LEN_TIRE_TEMP_B_R_1 ((uint16_t) 8)
#define CAN_LEN_TIRE_TEMP_B_R_2 ((uint16_t) 8)
#define CAN_LEN_TIRE_TEMP_B_R_3 ((uint16_t) 8)
#define CAN_LEN_TIRE_TEMP_B_R_4 ((uint16_t) 8)
